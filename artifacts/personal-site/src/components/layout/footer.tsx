      ...
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
          <div className="col-span-1 md:col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-6 group inline-flex">
              <div className="w-8 h-8 bg-secondary transition-colors rounded-sm flex items-center justify-center">
                <span className="text-foreground font-mono font-bold text-lg leading-none pt-0.5">E</span>
              </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-background/70">
              <li><a href="mailto:hello@elenavance.co" className="hover:text-secondary transition-colors">hello@elenavance.co</a></li>
              <li><a href="#" className="hover:text-secondary transition-colors">San Francisco, CA</a></li>
              <li><a href="#" className="hover:text-secondary transition-colors">+1 (555) 123-4567</a></li>
            </ul>
          </div>
        </div>
